...
const RealPost = () => {
    return (
        <div className="rounded-md shadow-md max-w-full mx-2 bg-gray-900 text-gray-100">
            <div className="flex items-center justify-between p-3">
                ...
                <button title="Open options" type="button" className='hidden md:block'>
            ...
            <div className="p-3">
                ...
                <div className="my-3">
                    <p className="text-sm mb-4 text-start">
                        <h2>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magnam perspiciatis optio nemo enim voluptate exercitationem pariatur qui explicabo tempora quas?</h2>
                    </p>
